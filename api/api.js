 ...
 */
var CHARACTERS, CHARMAP, INVALID_CHARACTERS, InvalidSequenceError, KVDB, Platform, QSCMobile, User, View, char, decode, encode, fromCharCode, i, pack, unpack, _i, _len, _ref,
...
encode = this.btoa != null ? this.btoa : this.btoa = function(input) {
  var chr1, chr2, chr3, enc1, enc2, enc3, enc4, invalidChar, output, _j, _len1, _ref1;
  output = '';
  i = 0;
...
decode = this.atob != null ? this.atob : this.atob = function(input) {
...
unpack = function(utfstring) {
  var c, string, _j, _ref1;
  utfstring = utfstring.replace(/\r\n/g, '\n');
  string = '';
  for (i = _j = 0, _ref1 = utfstring.length - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
...
KVDB = (function(_super) {
  ...
  KVDB.prototype.get = function(key, success, error) {
    ...
    callback = function(data) {
      ...
      _ref1 = JSON.parse(data), type = _ref1.type, value = _ref1.value;
      if (type === "number") {
        if (value.indexOf(".") > -1) {
...
QSCMobile = (function() {
  ...
  function QSCMobile(pluginID) {
    var api, _j, _len1, _ref1;
    this.pluginID = pluginID;
    _ref1 = ['KVDB', 'View', 'User'];
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      api = _ref1[_j];
