...
*/var CHARACTERS, CHARMAP, INVALID_CHARACTERS, InvalidSequenceError, KVDB, Platform, QSCMobile, User, View, char, decode, encode, fromCharCode, i, pack, unpack, _len, _ref, _ref2, _ref3;
...
InvalidSequenceError = (function() {
  __extends(InvalidSequenceError, Error);
...
encode = (_ref2 = this.btoa) != null ? _ref2 : this.btoa = function(input) {
  var char, chr1, chr2, chr3, enc1, enc2, enc3, enc4, invalidChar, output, _i, _len2, _ref3;
  output = '';
  i = 0;
...
decode = (_ref3 = this.atob) != null ? _ref3 : this.atob = function(input) {
...
unpack = function(utfstring) {
  var c, i, string, _ref4;
  utfstring = utfstring.replace(/\r\n/g, '\n');
  string = '';
  for (i = 0, _ref4 = utfstring.length - 1; 0 <= _ref4 ? i <= _ref4 : i >= _ref4; 0 <= _ref4 ? i++ : i--) {
...
Platform = (function() {
  ...
  Platform.prototype.sendRequest = function(request) {
    ...
    callback = function(data) {
      var _ref4;
      _ref4 = data, data = _ref4.data, error = _ref4.error;
      if (error) {
...
KVDB = (function() {
  ...
  KVDB.prototype.get = function(key, success, error) {
    ...
    callback = function(data) {
      ...
      _ref4 = JSON.parse(data), type = _ref4.type, value = _ref4.value;
      if (type === "number") {
        if (value.indexOf(".") > -1) {
...
QSCMobile = (function() {
  /*
    ...
    */  function QSCMobile(pluginID) {
    var api, _i, _len2, _ref4;
    this.pluginID = pluginID;
    _ref4 = ['KVDB', 'View', 'User'];
